...
var whatsapp_number ="&text=✅ _Registro confirmado_"+ "%20" + "*marketing-soft.com™*" + "%0A"+"_________________________" + "%0A"+"%0A"+ "👤 *Nombre*" +"%0A" + nombre + "%20" +"%0A"+"%0A" +"⚜️ *Nombre del Negocio*" +"%0A" + nombrenegocio +  "%20" + "%0A"+"%0A"+"⭐ *Tipo de Negocio*"+"%0A" + tipodenegocio + "%20"+ "%0A"+"%0A"+"📌 *Tipo de Servicio*"+"%0A"+tipodeservicio+ "%0A"+"%0A"+"⏳ *Día y hora para contacto*"+"%0A" +horaprueba+"%0A" + "%0A"+ "_________________________" + "%0A" + "%0A"+"*P.D.*"+ "%20"+ "Por favor guarda nuestro contacto para poder recibir toda la información 😉👍";
